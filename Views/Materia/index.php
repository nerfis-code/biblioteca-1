...
<div class="app-title">
    <div>
        <h1><i class="fa fa-dashboard"></i> Genero</h1>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title text-white" id="title">Registrar Genero</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="materia" class="form-control" type="text" name="materia" required placeholder="Nombre de genero">
                            </div>
                        </div>
